...
(function() {
    ...
    const QUESTS = [
        ...
        { id: 'barfuss',          emoji: '👣', diff: 'easy',   xp: 30,
          title: 'Barfuss-Strand',
          desc: 'Einmal den ganzen Strand barfuss ablaufen &ndash; Sand zwischen den Zehen!' },
        ...
        { id: 'heimbaecker',      emoji: '🍪', diff: 'medium', xp: 40,
          title: 'Heim-Baecker',
          desc: 'Etwas Suesses fuer die ganze Familie backen.' },
        ...
        { id: 'lesestunde',       emoji: '📖', diff: 'easy',   xp: 30,
          title: 'Lese-Stunde',
          desc: 'Eine Stunde draussen lesen statt aufs Handy zu schauen.' },
        { id: 'marktkoch',        emoji: '🍅', diff: 'medium', xp: 50,
          title: 'Markt-Koch',
          desc: 'Frische Zutaten vom Markt kaufen und etwas daraus kochen.' },
        ...
        { id: 'hundefreund',      emoji: '🐕', diff: 'easy',   xp: 20,
          title: 'Hunde-Freund',
          desc: 'Einen fremden, lieben Hund streicheln duerfen.' },
