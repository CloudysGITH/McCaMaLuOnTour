...
(function() {
    ...
    const QUESTS = [
        ...
        { id: 'postkarte',   emoji: '✉️', diff: 'medium', xp: 50,
        ...
        { id: 'knoten',           emoji: '🪢', diff: 'medium', xp: 40,
          title: 'Knoten-Meister',
          desc: 'Einen echten Seemannsknoten lernen und ihn auswendig binden koennen.' },
        { id: 'radschlag',        emoji: '🤸', diff: 'medium', xp: 40,
          title: 'Rad-Schlaeger',
          desc: 'Am Strand ein sauberes Rad oder einen Handstand schaffen.' },
        { id: 'steinturm',        emoji: '🪨', diff: 'medium', xp: 40,
          title: 'Steinturm-Balance',
          desc: 'Einen moeglichst hohen Steinturm balancieren, ohne dass er umfaellt.' },
        { id: 'steinmaler',       emoji: '🖌️', diff: 'medium', xp: 40,
          title: 'Stein-Maler',
          desc: 'Einen Stein bunt bemalen und verschenken oder am Strand verstecken.' },
        { id: 'kartentrick',      emoji: '🃏', diff: 'medium', xp: 40,
          title: 'Karten-Trick',
          desc: 'Einen Kartentrick lernen und der Familie vorfuehren, ohne dich zu verraten.' },
        { id: 'quizmaster',       emoji: '🧩', diff: 'medium', xp: 50,
          title: 'Quiz-Master',
          desc: 'Ein kniffliges Familien-Quiz ueber den Urlaub ausdenken und alle raten lassen.' },
        { id: 'songumdichter',    emoji: '🎵', diff: 'medium', xp: 40,
          title: 'Song-Umdichter',
          desc: 'Ein Lied mit eigenem Urlaubs-Text umdichten und der Crew vorsingen.' },
        { id: 'handschlag',       emoji: '🤝', diff: 'easy',   xp: 30,
          title: 'Geheim-Handschlag',
          desc: 'Mit jemandem einen richtig coolen geheimen Handschlag erfinden und merken.' },
        { id: 'duene',            emoji: '🏜️', diff: 'easy',   xp: 30,
          title: 'Duenen-Sturm',
          desc: 'Eine Sandduene hochklettern und wieder runterrennen &ndash; so schnell es geht!' },
